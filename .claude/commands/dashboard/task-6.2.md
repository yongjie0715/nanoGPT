...
Execute task 6.2 for the dashboard specification.

## Task Description
Add training session identification

## Code Reuse
**Leverage existing code**: existing message formatting structure
...
Execute with @spec-task-executor agent the following task: "Add training session identification"

```
Use the @spec-task-executor agent to implement task 6.2: "Add training session identification" for the dashboard specification and include all the below context.
...
## Task Details
- Task ID: 6.2
- Description: Add training session identification
- Leverage: existing message formatting structure
- Requirements: Requirement 6 (Training Process Integration)

## Instructions
- Implement ONLY task 6.2: "Add training session identification"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks dashboard 6.2 --mode complete
...
```bash
claude-code-spec-workflow get-tasks dashboard 6.2 --mode complete
```
