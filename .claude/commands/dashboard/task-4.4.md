...
Execute task 4.4 for the dashboard specification.

## Task Description
Add chart screenshot/image export capability

## Code Reuse
**Leverage existing code**: Chart.js built-in export functionality

## Requirements Reference
**Requirements**: Requirement 5 (Data Export and Sharing Capabilities)
...
Execute with @spec-task-executor agent the following task: "Add chart screenshot/image export capability"

```
Use the @spec-task-executor agent to implement task 4.4: "Add chart screenshot/image export capability" for the dashboard specification and include all the below context.
...
## Task Details
- Task ID: 4.4
- Description: Add chart screenshot/image export capability
- Leverage: Chart.js built-in export functionality
- Requirements: Requirement 5 (Data Export and Sharing Capabilities)

## Instructions
- Implement ONLY task 4.4: "Add chart screenshot/image export capability"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks dashboard 4.4 --mode complete
...
```bash
claude-code-spec-workflow get-tasks dashboard 4.4 --mode complete
```
